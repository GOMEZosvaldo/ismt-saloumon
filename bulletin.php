    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown text-capitalize"><a href="about.html"><span>à propos</span></a>
            <!-- <ul>
              <li><a href="about.html">à propos de nous</a></li>
              <li><a href="admissions.html">Admissions</a></li>
              <li><a href="academics.html">Universitaires</a></li>
              <li><a href="faculty-staff.html">Faculté &amp; personnel </a></li>
              <li><a href="campus-facilities.html">Campus &amp; installations </a></li>
            </ul> -->
          </li>

          <li><a href="contact.html">Contact</a></li>

          <li><a href="inscrire.html">Inscriptions</a></li>
          <li><a href="students-life.html">Suivie d'étudiant</a></li>
          <!-- <li><a href="news.html">Nouvelles</a></li>
          <li><a class="text-capitalize" href="events.html">événement</a></li> -->
          <!-- <li><a href="alumni.html">parent éleves</a></li> -->
